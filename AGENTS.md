...
Plan of record: `C:/Users/Lenovo/.Codex/plans/great-when-you-really-iridescent-ocean.md`.
...
- **Enforcement paths** (`.Codex/hooks/*`, `scripts/append_decision.ps1`, `.Codex/settings.json`, `qa/hooks/*`) need `Approved-by: Umesh` on the authorizing entry.
