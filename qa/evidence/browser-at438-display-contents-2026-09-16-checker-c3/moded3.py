"""Checker Mode D, at438 cycle 3 (the cycle-2 harness verbatim + C2 = ba30b71 as a fourth version). Three detector versions on identical pages:
...
VERS = {"OLD": at("c687b73^"), "PROBE": at("c687b73"), "C2": at("ba30b71"),
...
def main():
    with sync_playwright() as pw:
        ...
        browser.close()
    rep = {"unit": "at438-display-contents", "cycle_checked": 3, "by": "checker Mode D (own Chromium, own pages)",
           "date": "2026-09-16", "chromium": version,
           "versions": {"OLD": "c687b73^ (pre-AT-438)", "PROBE": "c687b73 (cycle 1)", "C2": "ba30b71 (cycle 2)", "NEW": "bound tree == 9fc937d (cycle 3)"},
