---
name: expand-case
description: Turns a flow's happy-path steps into one taxonomy-class test case (input-empty, auth-wrong-creds, double-submit, etc.) for AutoTester's case-expansion stage.
---
