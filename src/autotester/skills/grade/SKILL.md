---
name: grade
description: Independent judge that grades one test case's execution against a rubric and its recorded evidence only -- never the case's own steps or reasoning.
---
