---
name: video-issues
description: Finds what is wrong in one section of a product demo recording -- bugs, feature gaps, wrong-model choices -- separate from the screen-mapping pass.
---
