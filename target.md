...
## Progress (from `.goal/goal.json`, 2026-09-24): 38 / 67 done (57% — the roadmap grew by 12 tasks via D-040/D-041/D-042, not a regression). In flight: T-170, AT-110. Next: T-172, T-173, AT-086/087, T-175, T-126, AT-335, then T-125 / T-165 / T-179..T-181.
